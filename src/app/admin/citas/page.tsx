...
function DeleteButton({ appointmentId }: { appointmentId: string }) {
  return (
    <form action={deleteAppointmentAction}>
      ...
      <button
        type="submit"
        className="rounded-full border border-red-800 bg-red-950/20 px-4 py-2 text-xs font-semibold text-red-300 transition hover:border-red-500 hover:bg-red-950/40"
